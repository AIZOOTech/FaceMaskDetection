...
model = caffe.Net('models/face_mask_detection.prototxt','models/face_mask_detection.caffemodel', caffe.TEST)
...
def inference(image,
    ...
    y_bboxes_output = result['loc_branch_concat']
    y_cls_output = result['cls_branch_concat']
